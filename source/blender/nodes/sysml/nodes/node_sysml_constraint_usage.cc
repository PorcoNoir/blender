...
static void sysml_constraint_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_constraint_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeConstraintUsage"_ustr);
  ntype.ui_name = "Constraint Usage";
  ntype.ui_description = "SysML v2 constraint usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_constraint_usage_init;

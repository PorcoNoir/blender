...
static void sysml_analysis_case_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_analysis_case_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeAnalysisCaseUsage"_ustr);
  ntype.ui_name = "Analysis Case Usage";
  ntype.ui_description = "SysML v2 analysis case usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_analysis_case_usage_init;

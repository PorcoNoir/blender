...
static void sysml_reference_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_reference_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeReferenceUsage"_ustr);
  ntype.ui_name = "Reference Usage";
  ntype.ui_description = "SysML v2 reference usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_reference_usage_init;

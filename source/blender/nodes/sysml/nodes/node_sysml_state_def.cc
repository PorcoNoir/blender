...
static void sysml_state_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_state_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeStateDef"_ustr);
  ntype.ui_name = "State Definition";
  ntype.ui_description = "SysML v2 state definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_state_def_init;

...
static void sysml_viewpoint_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_viewpoint_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeViewpointUsage"_ustr);
  ntype.ui_name = "Viewpoint Usage";
  ntype.ui_description = "SysML v2 viewpoint usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_viewpoint_usage_init;

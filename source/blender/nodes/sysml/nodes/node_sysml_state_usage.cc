...
static void sysml_state_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_state_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeStateUsage"_ustr);
  ntype.ui_name = "State Usage";
  ntype.ui_description = "SysML v2 state usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_state_usage_init;

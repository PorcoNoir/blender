...
static void sysml_concern_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_concern_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeConcernUsage"_ustr);
  ntype.ui_name = "Concern Usage";
  ntype.ui_description = "SysML v2 concern usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_concern_usage_init;

...
static void sysml_calc_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_calc_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeCalcDef"_ustr);
  ntype.ui_name = "Calc Definition";
  ntype.ui_description = "SysML v2 calc definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_calc_def_init;

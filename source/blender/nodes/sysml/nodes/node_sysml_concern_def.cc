...
static void sysml_concern_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_concern_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeConcernDef"_ustr);
  ntype.ui_name = "Concern Definition";
  ntype.ui_description = "SysML v2 concern definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_concern_def_init;

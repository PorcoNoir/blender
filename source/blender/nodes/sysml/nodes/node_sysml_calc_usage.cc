...
static void sysml_calc_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_calc_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeCalcUsage"_ustr);
  ntype.ui_name = "Calc Usage";
  ntype.ui_description = "SysML v2 calc usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_calc_usage_init;

...
static void sysml_port_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_port_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodePortDef"_ustr);
  ntype.ui_name = "Port Definition";
  ntype.ui_description = "SysML v2 port definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_port_def_init;

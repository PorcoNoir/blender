...
static void sysml_view_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_view_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeViewUsage"_ustr);
  ntype.ui_name = "View Usage";
  ntype.ui_description = "SysML v2 view usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_view_usage_init;

...
static void sysml_case_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_case_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeCaseUsage"_ustr);
  ntype.ui_name = "Case Usage";
  ntype.ui_description = "SysML v2 case usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_case_usage_init;

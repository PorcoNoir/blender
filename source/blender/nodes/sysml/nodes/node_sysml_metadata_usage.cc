...
static void sysml_metadata_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_metadata_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeMetadataUsage"_ustr);
  ntype.ui_name = "Metadata Usage";
  ntype.ui_description = "SysML v2 metadata usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_metadata_usage_init;

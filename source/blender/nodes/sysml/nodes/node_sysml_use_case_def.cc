...
static void sysml_use_case_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_use_case_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeUseCaseDef"_ustr);
  ntype.ui_name = "Use Case Definition";
  ntype.ui_description = "SysML v2 use case definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_use_case_def_init;

...
static void sysml_viewpoint_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_viewpoint_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeViewpointDef"_ustr);
  ntype.ui_name = "Viewpoint Definition";
  ntype.ui_description = "SysML v2 viewpoint definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_viewpoint_def_init;

...
static void sysml_port_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_port_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodePortUsage"_ustr);
  ntype.ui_name = "Port Usage";
  ntype.ui_description = "SysML v2 port usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_port_usage_init;

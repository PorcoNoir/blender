...
static void sysml_interface_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_interface_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeInterfaceDef"_ustr);
  ntype.ui_name = "Interface Definition";
  ntype.ui_description = "SysML v2 interface definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_interface_def_init;

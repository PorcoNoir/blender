...
static void sysml_flow_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_flow_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeFlowDef"_ustr);
  ntype.ui_name = "Flow Definition";
  ntype.ui_description = "SysML v2 flow definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_flow_def_init;

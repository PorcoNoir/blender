...
static void sysml_attribute_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_attribute_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeAttributeDef"_ustr);
  ntype.ui_name = "Attribute Definition";
  ntype.ui_description = "SysML v2 attribute definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_attribute_def_init;

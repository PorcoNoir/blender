...
static void sysml_item_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_item_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeItemDef"_ustr);
  ntype.ui_name = "Item Definition";
  ntype.ui_description = "SysML v2 item definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_item_def_init;

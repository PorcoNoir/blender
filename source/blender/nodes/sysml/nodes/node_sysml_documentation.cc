...
static void sysml_documentation_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_documentation()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeDocumentation"_ustr);
  ntype.ui_name = "Documentation";
  ntype.ui_description = "SysML v2 documentation";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_documentation_init;

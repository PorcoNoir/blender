...
static void sysml_binding_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_binding_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeBindingUsage"_ustr);
  ntype.ui_name = "Binding Usage";
  ntype.ui_description = "SysML v2 binding usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_binding_usage_init;

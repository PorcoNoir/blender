...
static void sysml_requirement_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_requirement_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeRequirementDef"_ustr);
  ntype.ui_name = "Requirement Definition";
  ntype.ui_description = "SysML v2 requirement definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_requirement_def_init;

...
static void sysml_attribute_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_attribute_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeAttributeUsage"_ustr);
  ntype.ui_name = "Attribute Usage";
  ntype.ui_description = "SysML v2 attribute usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_attribute_usage_init;

...
static void sysml_allocation_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_allocation_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeAllocationUsage"_ustr);
  ntype.ui_name = "Allocation Usage";
  ntype.ui_description = "SysML v2 allocation usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_allocation_usage_init;

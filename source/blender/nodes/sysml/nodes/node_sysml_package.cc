...
static void sysml_package_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_package()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodePackage"_ustr);
  ntype.ui_name = "Package";
  ntype.ui_description = "SysML v2 package";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_package_init;

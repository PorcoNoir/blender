...
static void sysml_rendering_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_rendering_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeRenderingUsage"_ustr);
  ntype.ui_name = "Rendering Usage";
  ntype.ui_description = "SysML v2 rendering usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_rendering_usage_init;

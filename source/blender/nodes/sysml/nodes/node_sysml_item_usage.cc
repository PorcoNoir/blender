...
static void sysml_item_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_item_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeItemUsage"_ustr);
  ntype.ui_name = "Item Usage";
  ntype.ui_description = "SysML v2 item usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_item_usage_init;

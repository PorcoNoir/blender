...
static void sysml_import_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_import()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeImport"_ustr);
  ntype.ui_name = "Import";
  ntype.ui_description = "SysML v2 import";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_import_init;

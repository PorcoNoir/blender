...
static void sysml_succession_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_succession_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeSuccessionUsage"_ustr);
  ntype.ui_name = "Succession Usage";
  ntype.ui_description = "SysML v2 succession usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_succession_usage_init;

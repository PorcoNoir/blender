...
static void sysml_case_def_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_case_def()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeCaseDef"_ustr);
  ntype.ui_name = "Case Definition";
  ntype.ui_description = "SysML v2 case definition";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_case_def_init;

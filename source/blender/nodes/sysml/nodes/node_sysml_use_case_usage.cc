...
static void sysml_use_case_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_use_case_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeUseCaseUsage"_ustr);
  ntype.ui_name = "Use Case Usage";
  ntype.ui_description = "SysML v2 use case usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_use_case_usage_init;

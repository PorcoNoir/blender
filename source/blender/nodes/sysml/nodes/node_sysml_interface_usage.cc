...
static void sysml_interface_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_interface_usage()
{
  ...
  sysml_node_type_base(&ntype, "SysMLNodeInterfaceUsage"_ustr);
  ntype.ui_name = "Interface Usage";
  ntype.ui_description = "SysML v2 interface usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_interface_usage_init;

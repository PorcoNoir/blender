...
static void sysml_action_usage_init(bNodeTree *ntree, bNode *node)
{
...
void register_node_type_sysml_action_usage()
{
  static bke::bNodeType ntype;

  sysml_node_type_base(&ntype, "SysMLNodeActionUsage"_ustr);
  ntype.ui_name = "Action Usage";
  ntype.ui_description = "SysML v2 action usage";
  ntype.nclass = NODE_CLASS_INPUT;
  ntype.initfunc = sysml_action_usage_init;

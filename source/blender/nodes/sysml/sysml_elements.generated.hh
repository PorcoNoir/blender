...
#define SYSML_ELEMENT_KINDS \
  X("sysml.action_def", "SysMLNodeActionDef", "Action Definition", false, false, false) \
  ...
  X("sysml.allocation_def", "SysMLNodeAllocationDef", "Allocation Definition", false, false, false) \
  ...
  X("sysml.calc_def", "SysMLNodeCalcDef", "Calc Definition", false, false, false) \
  ...
  X("sysml.concern_def", "SysMLNodeConcernDef", "Concern Definition", false, false, false) \
  ...
  X("sysml.connection_def", "SysMLNodeConnectionDef", "Connection Definition", false, false, false) \
  X("sysml.connection_usage", "SysMLNodeConnectionUsage", "Connection Usage", false, true, false) \
  X("sysml.constraint_def", "SysMLNodeConstraintDef", "Constraint Definition", false, false, false) \
  ...
  X("sysml.enumeration_def", "SysMLNodeEnumerationDef", "Enumeration Definition", false, false, false) \
  X("sysml.enumeration_usage", "SysMLNodeEnumerationUsage", "Enumeration Usage", false, true, false) \
  X("sysml.flow_def", "SysMLNodeFlowDef", "Flow Definition", false, false, false) \
  X("sysml.flow_usage", "SysMLNodeFlowUsage", "Flow Usage", false, true, false) \
  X("sysml.import", "SysMLNodeImport", "Import", false, false, false) \
  X("sysml.interface_def", "SysMLNodeInterfaceDef", "Interface Definition", false, false, false) \
  X("sysml.interface_usage", "SysMLNodeInterfaceUsage", "Interface Usage", false, true, false) \
  X("sysml.item_def", "SysMLNodeItemDef", "Item Definition", false, false, false) \
  ...
  X("sysml.metadata_def", "SysMLNodeMetadataDef", "Metadata Definition", false, false, false) \
  X("sysml.metadata_usage", "SysMLNodeMetadataUsage", "Metadata Usage", false, true, false) \
  X("sysml.occurrence_def", "SysMLNodeOccurrenceDef", "Occurrence Definition", false, false, false) \
  ...
  X("sysml.rendering_def", "SysMLNodeRenderingDef", "Rendering Definition", false, false, false) \
  X("sysml.rendering_usage", "SysMLNodeRenderingUsage", "Rendering Usage", false, true, false) \
  X("sysml.requirement_def", "SysMLNodeRequirementDef", "Requirement Definition", false, false, false) \
  X("sysml.requirement_usage", "SysMLNodeRequirementUsage", "Requirement Usage", false, true, false) \
  X("sysml.state_def", "SysMLNodeStateDef", "State Definition", false, false, false) \
  ...
  X("sysml.view_def", "SysMLNodeViewDef", "View Definition", false, false, false) \
  X("sysml.view_usage", "SysMLNodeViewUsage", "View Usage", false, true, false) \
  X("sysml.viewpoint_def", "SysMLNodeViewpointDef", "Viewpoint Definition", false, false, false) \
